...
format:
  html:
    include-in-header:
      text: <script type="text/javascript" src="smart-scroll.js"></script>
    css:
      - styles.css
...
The goal of this writeup is to understand the parameters particular [game](#investment-game) and its optimal strategy, called the **Kelly Criterion**. This game is relevant to investment strategy. 
...
ax_in.hist(
    final_balances,
    bins=bins,                       # 👈 explicit 5k bin width
    color="#74add1",
    edgecolor="white",
    alpha=0.9
)
